  ...
  return (
    <>
      <PageHero
        ...
        description="We build the software that runs your business, staff the people who manage it, and support the customers it serves. From Wyoming and Karachi, under one accountable partnership."
