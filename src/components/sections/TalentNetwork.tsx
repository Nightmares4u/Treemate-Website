          ...
          >
            {pillars.map((pillar) => (
              <motion.div
                key={pillar.title}
                variants={fadeIn}
                className="flex gap-5 rounded-2xl border border-slate-200 bg-base p-6 hover:border-teal/30 transition-colors"
              >
                ...
                <div>
                  <h3 className="font-heading font-bold text-lg text-navy mb-1.5">{pillar.title}</h3>
